...
public class ExpressionParser implements TripleParser, ListParser {
    ...
    @Override
    public MultiExpression parse(String expression, List<String> variables) throws Exception {
    ...
    @Override
    public MultiExpression parse(String expression) throws Exception {
        this.expression = expression;
    ...
    public MultiExpression parse() throws Exception {
    ...
    private ExpressionImpl buildExpression(List<String> postfix) {
        ...
        if (trans == '_') {
            return new CheckedNegate(buildExpression(postfix));
        }
        if (element.equals("l0")) {
            return new LeadingZero(buildExpression(postfix));
        }
        if (element.equals("t0")) {
            return new TrailingZero(buildExpression(postfix));
        }
